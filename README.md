...
<ul>
<li>Here is a code for our Simple Shell code/project that is able to display prompts and execute simple commands utilizing the C programming language. Our shell tackles interactive and non interactive mode withing the shell.</li>
</ul>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzNzI4OTk3NF19
-->